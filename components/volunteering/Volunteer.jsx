...
const Volunteer = () => {
	const volunteerings = [
		...
		},
		{
			...
			description2:
				"OpenMind is a community that is data privacy driven especially in the field of AI",
		},
		{
			id: 3,
			...
			description:
				"I partaked in a project that influenced the Polish Government Policy on Sex Education. ",
			description2:
				"I was a task manager of 3-6 team members that worked on an important feature of this project. ",
		},

		{
			...
			description:
				"I was one of the data science instructor and mentor during Cohort 3 at AI Saturday Lagos. ",
		},
	];
