	...
	return (
		<section className={styles.skillsWrapper}>
			...
			<div className={`${styles.skills} container`}>
				<div>
					<svg strokeWidth="0" viewBox="0 0 24 24" className="Home_icon__fYoji" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
				...
				<div>
					<svg viewBox="0 0 24 24" className="Home_icon__fYoji" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
