...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      company: "Anheuser- Busch InBev",
      location: "Nigeria",
      description: "I work as the lead AI developer and team lead. My team and I use computer vision's algorithms to solve manufacturing and sales processes. This solution improves our customer's businesses and consumer experiences.",
    },
  ];
